...
public class UploadImageUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(UploadImageUser.this);
            ...
            switch (requestCode){
                case 0:
                    if(resultCode == RESULT_OK && data !=null){
                        ...
                        selectedImage = FileUtils.getPath(UploadImageUser.this, getImageUri(UploadImageUser.this,image));
                ...
                case 1:
                    if(resultCode == RESULT_OK && data !=null){
                        ...
                        selectedImage = FileUtils.getPath(UploadImageUser.this,image);
    ...
    public void requirePermission(){
        ActivityCompat.requestPermissions(UploadImageUser.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
    }
    ...
    public void uploadFileToServer(){
        ...
        Call<FileModel> call = userApi.postImageUser(filePart, email, user_id);
        call.enqueue(new Callback<FileModel>() {
            @Override
            public void onResponse(Call<FileModel> call, Response<FileModel> response) {
                Log.d("devErrors", "image correct");
                FileModel fileModel = response.body();
                Intent intent = new Intent(UploadImageUser.this, MainActivity.class);
                intent.putExtra("user_id", user_id);
                Toast toast = Toast.makeText(UploadImageUser.this,"Succesfully registered",Toast. LENGTH_SHORT);
                toast.show();
            ...
            public void onFailure(Call<FileModel> call, Throwable t) {
                ...
                Intent intent = new Intent(UploadImageUser.this, MainActivity.class);
                startActivity(intent);
                Toast.makeText(UploadImageUser.this, "Successfully Created", Toast.LENGTH_SHORT).show();
            }
        });
    }
}